...
public class AdminMainPanelController implements Initializable {
    ...
    @FXML
    private void deleteAccountButtonOnClick(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
    ...
    @FXML
    private void banAccButtonOnClick(ActionEvent event) throws IOException{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("BanAccount.fxml"));
        Parent nextFXML = loader.load();

        Scene nextScene = new Scene(nextFXML);

        BanAccountController controller = loader.getController();
        controller.userInfo(u);
    ...
    @FXML
    private void reportsButtonOnClick(ActionEvent event)throws IOException {
        FXMLLoader loader = new FXMLLoader();
    ...
    @FXML
    private void createTournamentButtonOnClick(ActionEvent event) throws IOException{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("CreateTournament.fxml"));
        Parent nextFXML = loader.load();
